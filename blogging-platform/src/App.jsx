      ...
      <div className="flex-1 flex flex-col items-center space-y-8 w-full mt-4 sm:mt-6 px-2 sm:px-0">
        <div className="w-full max-w-5xl mx-auto">
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6 mb-8">
            ...
            {/* GitHub Button */}
            <a href="https://github.com/thespritesisodia" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-10 h-10 rounded-full border border-gray-700 bg-gray-900 hover:bg-gray-800 text-white transition-colors">
